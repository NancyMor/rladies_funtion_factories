...
5.- ¿Qé pasa si no usas un cierre? Haga predicciones, luego verifique con el código a continuación.
...
6.- ¿Qué pasa si usas en `<-` lugar de `<<-` ? Haga predicciones, luego verifique con el código a continuación.
